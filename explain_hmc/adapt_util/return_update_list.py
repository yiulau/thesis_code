...
def return_update_lists(adapter_meta):
    # returns three lists
    # fast list , medium list , slow list

    window_size = adapter_meta.window_size
    ...
    if tune_fast == True:
        ini_buffer = adapter_meta.dual_meta.ini_buffer
        end_buffer = adapter_meta.dual_meta.end_buffer
    if tune_medium == True:
        min_medium_updates = adapter_meta.opt_meta.min_medium_updtes
    if tune_slow == True:
        min_slow_updates = adapter_meta.adapt_meta.min_slow_updates
